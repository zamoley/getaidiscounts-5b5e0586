...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Verified daily promos for HeyGen, ElevenLabs, and more." },
      { property: "og:title", content: "Get AI Discounts | Save BIG on your AI Stack" },
      { property: "og:description", content: "Verified daily promos for HeyGen, ElevenLabs, and more." },
      ...
      { name: "twitter:description", content: "Verified daily promos for HeyGen, ElevenLabs, and more." },
