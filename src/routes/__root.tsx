...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Get AI Discounts | #1 Directory for AI Tool Promo Codes" },
      { property: "og:title", content: "Get AI Discounts | #1 Directory for AI Tool Promo Codes" },
      { name: "twitter:title", content: "Get AI Discounts | #1 Directory for AI Tool Promo Codes" },
